Class AzureResourceManagerDeploymentService: IDeploymentService {
    ...
    [string] $armResourceGroupDeploymentUri = "https://management.core.usgovcloudapi.net/subscriptions/{0}/resourcegroups/{1}/providers/Microsoft.Resources/deployments/{2}?api-version=2019-05-10";
    [string] $armSubscriptionDeploymentUri = "https://management.core.usgovcloudapi.net/subscriptions/{0}/providers/Microsoft.Resources/deployments/{1}?api-version=2019-05-10"
    [string] $armResourceGroupValidationUri = "https://management.core.usgovcloudapi.net/subscriptions/{0}/resourcegroups/{1}/providers/Microsoft.Resources/deployments/{2}/validate?api-version=2019-05-10";
    [string] $armSubscriptionValidationUri = "https://management.core.usgovcloudapi.net/subscriptions/{0}/providers/Microsoft.Resources/deployments/{1}/validate?api-version=2019-05-10"
